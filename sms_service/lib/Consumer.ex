defmodule SmsService.Consumer do
  use GenServer
  use AMQP
  ...
  defp consume(channel, tag, redelivered, payload) do
    content = Poison.decode!(payload, as: %SmsService.Message{})
    SmsService.Sms.send_notification content.title, content.message, content.address
